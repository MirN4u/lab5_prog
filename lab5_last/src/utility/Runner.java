...
/**
 * Обработчик команд - класс, который запрашивает команду у консоли
 *
 * @author Miroslav
 * @version 1.0
 */
...
public class Runner {
    ...
    public void interactiveMode() {
        try {
            ...
            console.printError("Обработка Null команды");
        }
    }
        ...
        for (String script : scriptStack) {
            ...
            if (argument.equals(script)) {
                ...
                if (lengthRecursion < 0) {
                    ...
                    console.println("Введите максимальную глубину рекурсии (0..500)");
