...
public class Ask {
        ...
        try {
            ...
            while (true) {
                ...
                if (!name.isEmpty()) {
                    ...
                    console.printError("Введите name");
                }
            }
    ...
    public static Coordinates askCoordinates(Console console) throws AskBreak {
        try {
            ...
            while (true) {
                ...
                if (!line.equals("")) {
                    try {
                        ...
                        console.printError("Ошибка ввода, введите Double");
                    }
                } else {
            ...
            long y;
            while (true) {
                console.print("coordinates.y:(max=34,Long ) ");
                var line = console.readln().trim();
                if (line.equals("exit")) throw new AskBreak();
                if (!line.equals("")) {
                    try {
            ...
            while (true) {
                ...
                if (!line.equals("")) {
                    try {
                        ...
                        console.printError("Ошибка ввода, Double");
                    }
                } else {
                    console.printError("Введите данные");
                }
            ...
            while (true) {
                ...
                if (!line.equals("")) {
                    try {
                        ...
                        console.printError("Ошибка ввода, введите Integer");
                    }
                } else {
                    console.printError("Введите данные");
                }
